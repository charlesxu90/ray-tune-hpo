...
if __name__ == '__main__':
    ...
    parser.add_argument("--num-samples", type=int, default=50, help="Number of samples/trials to run")
    parser.add_argument("--max-concurrent-trials", type=int, default=4, help="Maximum trials to start concurrently. \
                        Will start equal to or less trials depending on the available resources")
    parser.add_argument('--logs-dir', type=str, default='logs', help="Create a logs directory within the experiment directory")
    ...
    analysis = tune.run(trainable, num_samples=args.num_samples, resources_per_trial={'cpu':1}, 
